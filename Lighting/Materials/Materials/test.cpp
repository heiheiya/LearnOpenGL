...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		GLint matAmbientLoc = glGetUniformLocation(program1.m_program, "material.ambient");
		GLint matDiffuseLoc = glGetUniformLocation(program1.m_program, "material.diffuse");
