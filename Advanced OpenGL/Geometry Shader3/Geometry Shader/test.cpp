...
int main()
{
	...
	Shader normalShader("shaders/normals.vs", "shaders/normals.gs", "shaders/normals.frag");
	...
	normalShader.Use();
	glUniformMatrix4fv(glGetUniformLocation(normalShader.m_program, "projection"), 1, GL_FALSE, glm::value_ptr(projection));
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		normalShader.Use();
		glUniformMatrix4fv(glGetUniformLocation(normalShader.m_program, "view"), 1, GL_FALSE, glm::value_ptr(camera.GetViewMatrix()));
		model = glm::mat4();
		glUniformMatrix4fv(glGetUniformLocation(normalShader.m_program, "model"), 1, GL_FALSE, glm::value_ptr(model));
